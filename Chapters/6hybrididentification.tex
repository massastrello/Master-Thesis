...
System (\ref{eq:HS}) is the single--\textit{flow} single--\textit{jump} specialization of the more general \textit{hybrid inclusions} whose framework is deeply explored in \textcolor{red}{Section ...}%\cite{goebel2009hybrid,Goebel2012}}.
%
\begin{figure}[!b]
	\centering
	\begin{tikzpicture}
...
\begin{prop}[Criteria for the norm bound of the Euler derivative]\label{prop:criteria}
   	%
...
{%\color{red} \\Answer to Reviewer \#1 (2) [Part 2.]\\
